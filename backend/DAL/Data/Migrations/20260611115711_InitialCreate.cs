        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medications_AspNetUsers_PharmacistId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CareType = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NursingRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NursingRequests_AspNetUsers_NurseId",
                        column: x => x.NurseId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NursingRequests_AspNetUsers_PatientId",
                        column: x => x.PatientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsultationReviews_Consultations_ConsultationId",
                        column: x => x.ConsultationId,
                        principalTable: "Consultations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NursingRequestId = table.Column<int>(type: "int", nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NursingReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NursingReviews_NursingRequests_NursingRequestId",
                        column: x => x.NursingRequestId,
                        principalTable: "NursingRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultationReviews_ConsultationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Medications_PharmacistId",
                table: "Medications",
                column: "PharmacistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NursingRequests_NurseId",
                table: "NursingRequests",
                column: "NurseId");

            migrationBuilder.CreateIndex(
                name: "IX_NursingRequests_PatientId",
                table: "NursingRequests",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_NursingReviews_NursingRequestId",
                table: "NursingReviews",
                column: "NursingRequestId",
                unique: true);
